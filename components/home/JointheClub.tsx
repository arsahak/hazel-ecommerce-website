        ...
        <ImageMotion>
          <div className="flex items-center justify-center flex-col">
            <div className="font-aviano-regular uppercase text-center w-full md:max-w-[70%] ">
              <h2 className="text-2xl md:text-4xl font-semibold text-center flex justify-center">
                Join the Club
              </h2>

              <h2 className="text-base md:text-xl font-semibold mt-3 ">
                These VIP Benefits give club members access to a fun, fresh and
                diverse catalogue, allowing them to discover and adopt the
                latest trends in the market first, making them the fashion
                experts!
              </h2>
            </div>
          </div>
